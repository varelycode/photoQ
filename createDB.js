...
var cmdStr = "CREATE TABLE photoTags (idNum INTEGER UNIQUE NOT NULL PRIMARY KEY, photoFile TEXT, photoWidth INTEGER, photoHeight INTEGER, location STRING, list TEXT)";
